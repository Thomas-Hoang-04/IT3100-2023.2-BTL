...
n = 200
# int(input("Nhập số lượng mẫu: "))
k = 200
# int(input("Nhập số lượng các giá trị phân biệt của mẫu: "))
min_value = 100
# float(input("Nhập giá trị tối thiểu của mẫu: "))
max_value = 3600
# float(input("Nhập giá trị tối đa của mẫu: "))
